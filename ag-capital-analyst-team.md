...
1. **Buffett Analyst** — `run_subagent(subagent_type="research")`
2. **Growth Analyst** — `run_subagent(subagent_type="research")`
3. **Technical Analyst** — `run_subagent(subagent_type="research")`
4. **Fundamentals Analyst** — `run_subagent(subagent_type="research")`
5. **Sentiment Analyst** — `run_subagent(subagent_type="research")`
